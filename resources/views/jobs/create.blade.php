                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('jobs.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="budget" class="block mt-1 w-full" type="number" min="1" step="0.01" name="budget" :value="old('budget')" required />
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('jobs.index') }}" class="text-gray-500 hover:underline mr-4">Cancel</a>
                            <x-primary-button>
                                {{ __('Post Job') }}
                            </x-primary-button>
                        </div>
